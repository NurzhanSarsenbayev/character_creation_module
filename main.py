...
# New import
# From start_game_banner module import run_screensaver
from graphic_arts.start_game_banner import run_screensaver


def attack(char_name: str, char_class: str) -> str:
    """Функция, отвечающая за реализацию атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция, отвечающая за реализацию защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция, отвечающая за реализацию способностей."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция, отвечающая за реализацию тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция, отвечающая за реализацию выбора класса."""
